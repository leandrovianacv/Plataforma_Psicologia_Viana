...
def inicializar_banco():
    ...
    try:
        ...
        try:
            cur.execute("ALTER TABLE pacientes ADD COLUMN IF NOT EXISTS sexo VARCHAR(20)")
        except:
            pass
            ...
            if nome and telefone and queixa_principal and local:
                try:
                    ...
                    cur.execute(
                        ...
                        (nome_completo, telefone, email, data_nascimento, sexo, profissao, 
                         como_chegou, queixa_principal, medicacoes_atuais, observacoes_iniciais, local) 
                        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)""",
                        (nome, telefone, email, data_nascimento, sexo, profissao, como_chegou, 
    ...
    if not verificar_autenticacao():
        ...
        try:
            ...
            pacientes_df = pd.read_sql("""
                SELECT id, nome_completo, telefone, email, sexo, profissao, queixa_principal, local,
                ...
                with st.form("form_editar_paciente"):
                    ...
                    with col2:
                        sexo = st.selectbox(
                            "Sexo",
                            ["Feminino", "Masculino"],
                            index=["Feminino", "Masculino"].index(paciente_data['sexo']) if paciente_data['sexo'] in ["Feminino", "Masculino"] else 0
                        )
                                ...
                                try:
                                    ...
                                    cur.execute("""
                                        ...
                                        SET nome_completo = %s, telefone = %s, email = %s, 
                                            data_nascimento = %s, sexo = %s, profissao = %s, como_chegou = %s,
                                            queixa_principal = %s, medicacoes_atuais = %s, 
                                            observacoes_iniciais = %s, local = %s
                                        WHERE id = %s
                                    """, (nome, telefone, email, data_nascimento, sexo, profissao, 
